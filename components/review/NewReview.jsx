...
const NewReview = ({ product }) => {
  ...
  return (
    <div>
      <hr className="my-4" />
      <h1 className="text-black-500 review-title my-5 text-2xl">Ваше мнение о товаре</h1>

      <h3 className="text-black-500">Рейтинг</h3>
      ...
      <div className="mb-4 mt-5">
        <label className="text-black-500 block mb-1"> Комментарий </label>
        <textarea
          rows="4"
