          ...
          <div className="flex flex-col md:flex-row gap-4 lg:gap-8">
            <main className="md:w-2/3">
              <article className="border border-gray-200 bg-white shadow-sm rounded p-4 lg:p-6 mb-5">
                <h2 class="text-xl font-semibold mb-5">Информация о доставке</h2>
            ...
            <aside className="md:w-1/3">
              <article className="text-gray-600" style={{ maxWidth: "350px" }}>
                ...
                <h2 class="text-lg font-semibold mb-3">Товары в корзине</h2>

                {cart?.cartItems?.map((item) => (
                  <figure class="flex items-center mb-4 leading-5">
                    <div>
                      <div class="block relative w-20 h-15 rounded p-1 border border-gray-200">
                        <img
                          width="50"
                          height="50"
                          src={item.image}
                    ...
                    <figcaption class="ml-3">
                      ...
                      <p class="mt-1 text-gray-400">
                        Стоимость: {item.quantity * item.price} ₽
                      </p>
                    </figcaption>
                  </figure>
                ))}
