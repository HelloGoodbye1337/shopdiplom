...
const Filters = () => {
  ...
  return (
    <aside className="md:w-1/5 lg:w-1/4 px-4">
      <a
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        ...
        <div className="grid md:grid-cols-3 gap-x-2">
          <div className="mb-2">
            <input
              name="min"
              className="appearance-none border border-gray-200 bg-gray-100 rounded-md py-1 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full"
              type="number"
              placeholder="мин."
              value={min}
          ...
          <div className="mb-4">
            <button
              className="px-3 py-1 text-center w-full inline-block text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700"
          ...
          <li>
            <label className="flex items-center">
              <input
                name="category"
                type="checkbox"
                value="Фильтр воздушный"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Фильтр воздушный")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Фильтр воздушный </span>
            </label>
          </li>
        </ul>
